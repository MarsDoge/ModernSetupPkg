...
python3 "${PKG_DIR}/Scripts/SaveReview/wire.py" "${WORKSPACE}" "${MODERN_SETUP_DISPLAY_ENGINE}" ArmVirtQemuModernSetup.dsc ArmVirtQemuModernSetup.fdf ArmVirtQemuModernSetupFvMain.fdf.inc
