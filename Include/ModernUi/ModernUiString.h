...
typedef enum {
  ...
  ModernUiStringPreferencesInstruction,
  ModernUiStringPreferenceTheme,
  ModernUiStringPreferenceThemeSystem,
  ModernUiStringPreferenceThemeDark,
  ModernUiStringPreferenceThemeRed,
  ModernUiStringPreferenceDensity,
  ModernUiStringPreferenceDensityComfortable,
  ModernUiStringPreferenceDensityCompact,
  ModernUiStringPreferenceRememberLastPage,
  ModernUiStringPreferenceShowAdvancedHints,
  ModernUiStringPreferenceConfirmReset,
  ModernUiStringPreferenceSave,
